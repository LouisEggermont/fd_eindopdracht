    ...
    return (
      ...
      >
        {hover && (
          ...
          >
            <div className="mx-auto flex w-0 flex-col items-center justify-center bg-[#121212]">
              <TriangleFilled
                ref={triangleRef}
              ...
              <div
                ...
                className="relative whitespace-nowrap rounded-md bg-[#121212] p-2.5 text-[14px] leading-relaxed tracking-wide  text-white shadow-sm [font-weight:400]"
              >
                {content}
              </div>
