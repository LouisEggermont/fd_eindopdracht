...
export default function AboutPage() {
    return (
        <div className='flex lg:flex-row-reverse flex-col justify-between gap-6 my-11 prose-p:text-[#4a4a4a] prose-p:leading-relaxed'>
            ...
            {/* <p>I am a 23-year-old student at Howest Kortrijk, where I am studying Multimedia Creative Technologies with a focus on &ldquo;Next Web Development&rdquo;. My interest in web development started during my secondary school years at Athena Campus Heule. <br /><br /> In addition to web development, I am also a fan of analog photography and I served as head of &ldquo;PR &amp; Media&rdquo; for my students association EcLipticA for two years. In my free time I enjoy motorcycling and I stay involved in both design and development. Want to get to know me better? You can find some links below.</p> */}
            <p>I am a 23-year-old graduate from Howest Kortrijk, where I studied Multimedia Creative Technologies with a focus on &ldquo;Next Web Development&rdquo;. My interest in web development started during my secondary school years at Athena Campus Heule, where I studied multimedia. <br /><br /> 

In addition to web development, I am also a fan of analog photography. During my time as a student, I was actively involved in the student association EcLipticA, where I first served as head of &ldquo;PR &amp; Media&rdquo; for two years and later took on the role of president. <br /><br />

In my free time I enjoy motorcycling and I stay involved in both design and development. Want to get to know me better? You can find some links below.</p>
